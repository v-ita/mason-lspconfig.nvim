...
return {
  ...
  javascript = { "ast_grep", "biome", "codebook", "cssmodules_ls", "denols", "dprint", "ember", "eslint", "glint", "harper_ls", "htmx", "lwc_ls", "oxfmt", "oxlint", "quick_lint_js", "rome", "snyk_ls", "snyk_ls", "tailwindcss", "ts_ls", "tsgo", "unocss", "vtsls" },
  ["javascript.glimmer"] = { "ember", "glint" },
  javascriptreact = { "ast_grep", "biome", "codebook", "cssmodules_ls", "denols", "dprint", "emmet_language_server", "emmet_ls", "eslint", "graphql", "htmx", "oxfmt", "oxlint", "rome", "tailwindcss", "ts_ls", "tsgo", "unocss", "vtsls" },
  jinja = { "jinja_lsp" },
  jq = { "jqls" },
  json = { "ast_grep", "biome", "dprint", "jsonls", "oxfmt", "rome", "snyk_ls", "snyk_ls", "spectral" },
  ["json.openapi"] = { "vacuum" },
  json5 = { "oxfmt" },
  ...
  perl = { "perlnavigator" },
  pest = { "pest_ls" },
  php = { "ast_grep", "codebook", "harper_ls", "htmx", "intelephense", "laravel_ls", "phpactor", "psalm", "snyk_ls", "snyk_ls", "stimulus_ls", "tailwindcss", "unocss" },
  ...
  typescript = { "angularls", "ast_grep", "biome", "codebook", "cssmodules_ls", "denols", "dprint", "ember", "eslint", "glint", "harper_ls", "htmx", "oxfmt", "oxlint", "quick_lint_js", "rome", "snyk_ls", "snyk_ls", "tailwindcss", "ts_ls", "tsgo", "unocss", "vtsls" },
  ["typescript.glimmer"] = { "ember", "glint" },
  typescriptreact = { "angularls", "ast_grep", "biome", "codebook", "cssmodules_ls", "denols", "dprint", "emmet_language_server", "emmet_ls", "eslint", "graphql", "harper_ls", "htmx", "oxfmt", "oxlint", "rome", "tailwindcss", "ts_ls", "tsgo", "unocss", "vtsls" },
  typespec = { "tsp_server" },
